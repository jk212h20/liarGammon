...
function Client(config) {
  ...
  this.handleMessage = function (msg, params) {
    ...
    // Process message
    console.log('msg',msg);
    //console.log('comm.Message.REAL_ROLL_DICE',comm.Message.REAL_ROLL_DICE);
    if (msg == comm.Message.CREATE_GUEST) {
      ...
      this.handleRealRollDice(params);
      console.log('REAL_ROLL_DICE');
    }
...
/**
   ...
   * @param {Object} params - Message parameters
   */
 this.handleRealRollDice = function (params) {
  console.log('Real Dice rolledXXXX');
  console.log(params);
  console.log(this.match.currentGame);
};
   ...
   */
   this.reqRollDice = function (callback) {
    console.log('nick roll', callback);
   ...
   * @param {messageCallback} [callback] - Callback function to be called when server sends a reply
   */
  this.reqRealRollDice = function (callback) {
    console.log('nick real roll', callback);
    this.sendMessage(comm.Message.REAL_ROLL_DICE, undefined, callback);
  };
