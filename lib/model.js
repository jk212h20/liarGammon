...
Utils.deepCopy = function (oldObj) {
 //console.log('JSON.stringify(oldObj)', JSON.stringify(oldObj))
 ...
 */
Game.diceWasSet = function (game) {
  return (game.turnDice != null);
};
Game.lyingPhaseBegun = function (game) {
  return (game.realturnDice != null);
};
/**
...
Game.snapshotState = function (game) {
  console.log('turnDice',game.turnDice);
...
Game.restoreState = function (game) {
  console.log('previousTurnDice',game.previousTurnDice);
